...
export const ADMIN_MENU_REPLY_MARKUP = buildReplyKeyboard([
  ...
  ["🧩 Гаджет компании", "♻️ Сброс игрока"],
  ["🔄 Рестарт игры", "🏁 Старт хакатона"],
  ["🛑 Финиш хакатона", "♻️ Сброс хакатона"],
  ["📝 Последнее обновление", "📜 История обновлений"],
  ["📚 Список дат", "📅 Обновление за дату"],
  ["🌍 Глобальное событие", "🚪 Выйти из админки"],
  ["🏠 Домой"],
]);
