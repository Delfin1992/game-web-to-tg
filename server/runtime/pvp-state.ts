import type { DuelRoundType, DuelTacticId, PvpBoostId } from "../../shared/pvp-duel";
...
export const pendingPvpTacticsByUserId = new Map<string, Partial<Record<DuelRoundType, DuelTacticId>>>();
